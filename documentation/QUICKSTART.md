...
echo "╔════════════════════════════════════════════════════════════════════════════════════════╗"
echo "║          METADATA-BASED LSTM SoH/RUL MODELS - QUICK START GUIDE                      ║"
echo "╚════════════════════════════════════════════════════════════════════════════════════════╝"
...
echo ""
echo "   \$ python3 scripts/infer_hybrid.py --input cleaned_dataset/data/00001.csv"
echo ""
echo "   Output:"
echo "     • Prediction summary (SoC, SoH, RUL, reference values)"
echo "     • outputs/eda/00001.inference.csv (with EKF_SoC and predictions)"
echo ""
...
echo ""
echo ""
echo "   Train hybrid EKF+LSTM model (uses metadata for per-file parameters):"
echo ""
echo "   \$ python3 scripts/hybrid_train.py --max-files 100 --epochs 10"
echo ""
echo "   Output:"
...
echo "   ekf_soc_final: Final EKF SoC estimate"
echo ""
...
echo ""
echo ""
echo "   Override EKF parameters via CLI:"
echo ""
echo "   \$ python3 scripts/infer_hybrid.py \\"
echo "       --input cleaned_dataset/data/00001.csv \\"
echo "       --ekf-params '{\"C_nom\": 2.3, \"R0\": 0.055}'"
echo ""
echo ""
...
echo ""
echo "   Scripts:"
echo "     • scripts/lstm_soh.py (LSTM with real data)"
echo "     • scripts/hybrid_train.py (Hybrid EKF+LSTM training)"
echo "     • scripts/infer_hybrid.py (Inference with reference)"
